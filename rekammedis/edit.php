...
<div class="box">
	...
	<div class="row">
		<div class="col-lg-6 col-lg-offset-3">
			<?php
			$id = @$_GET['id'];
			$sql_rekammedis = mysqli_query($con, "SELECT * FROM tb_rekammedis INNER JOIN tb_poliklinik ON tb_rekammedis.id_poli = tb_poliklinik.id_poli INNER JOIN tb_pasien ON tb_rekammedis.id_pasien = tb_pasien.id_pasien WHERE id_rm ='$id'") or die(mysqli_error($con));
			...
			<form action="proses.php" method="post">
				...
				<div class="form-group">
					...
					<input type="text" name="dokter" id="dokter" value="<?= $_SESSION['nama_user'] ?>" class="form-control" required="" readonly>
				</div>
				<div class="form-group">
